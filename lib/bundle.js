	...
	render: function () {
		return React.createElement(
			...
			React.createElement(
				CardAction,
				{ expandable: true },
				React.createElement(FileChooseButton, { FileChange: this.handleMIMEChange, testprop: FileChooseButton.handleChange })
			),
			React.createElement(
				CardText,
				{ expandable: true },
...
var FileInfo = React.createClass({
	...
	handleStateChange: function (newattr) {
